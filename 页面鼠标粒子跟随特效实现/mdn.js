/*
 * @Author: your name
 * @Date: 2020-12-11 20:27:19
 * @LastEditTime: 2020-12-11 20:29:10
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \my-projectd:\项目管理\DEMO\mdn.js
 */
var dat = dat || {};
dat.gui = dat.gui || {};
dat.utils = dat.utils || {};
...
dat.utils.common = function() {
  ...
  return {
    ...
    each: function(a, e, c) {
      if (a) if (f && a.forEach && a.forEach === f) a.forEach(e, c);
      else if (a.length === a.length + 0) for (var b = 0,
      p = a.length; b < p && !(b in a && e.call(c, a[b], b) === this.BREAK); b++);
...
dat.dom.dom = function(f) {
  ...
  c = {
    makeSelectable: function(b, a) {
      void 0 !== b && void 0 !== b.style && (b.onselectstart = a ?
      function() {
        return ! 1
      }: function() {},
    ...
    removeClass: function(a, e) {
      if (e) {
        if (void 0 !== a.className) if (a.className === e) a.removeAttribute("class");
        else {
...
dat.controllers.NumberControllerSlider = function(f, a, d, e, c) {
  ...
  var p = function(c, e, d, f, u) {
    ...
    a.bind(this.__background, "mousedown",
    function(b) {
...
dat.color.interpret = function(f, a) {
  ...
  return function() {
    ...
    a.each(c,
    function(c) {
      if (c.litmus(b)) return a.each(c.conversions,
      function(c, f) {
        d = c.read(b);
        if (!1 === e && !1 !== d) return e = d,
        d.conversionName = f,
        d.conversion = c,
        a.BREAK
      }),
...
dat.GUI = dat.gui.GUI = function(f, a, d, e, c, b, p, q, l, r, n, u, A, g, k) {
  ...
  function t(a, c, h) {
    ...
    if (h instanceof l) {
      ...
      k.each(["updateDisplay", "onChange", "onFinishChange"],
      function(a) {
        var K = h[a],
        b = d[a];
        h[a] = d[a] = function() {
    ...
    } else h instanceof b ? (g.bind(c, "click",
    function() {
      g.fakeEvent(h.__checkbox, "click")
    }), g.bind(h.__checkbox, "click",
    function(a) {
      a.stopPropagation()
    })) : h instanceof p ? (g.bind(c, "click",
    function() {
  ...
  function L(a) {
    ...
    a.load && a.load.remembered ? k.each(a.load.remembered,
    function(b, c) {
      F(a, c, c == a.preset)
    }) : F(a, "Default", !1);
    g.bind(r, "change",
    ...
    g.bind(m, "keydown",
    function(a) { ! a.metaKey || 67 !== a.which && 67 != a.keyCode || B.hide()
    });
    g.bind(c, "click",
    function() {
  ...
  function C(a, b) {
    var c = {};
    k.each(a.__rememberedObjects,
    function(d, e) {
      var f = {};
      k.each(a.__rememberedObjectIndecesToControllers[e],
      function(a, c) {
  ...
  m = function(a) {
    ...
    if (k.isUndefined(a.parent)) {
      ...
      g.bind(this.__closeButton, "click",
      function() {
        c.closed = !c.closed
      })
    } else {
    ...
    g.bind(this.__ul, "webkitTransitionEnd",
    function() {
      c.onResize()
    });
    g.bind(this.__ul, "transitionend",
    function() {
      c.onResize()
    });
    g.bind(this.__ul, "oTransitionEnd",
    function() {
      c.onResize()
    });
    this.onResize();
  ...
  k.extend(m.prototype, {
    ...
    remember: function() {
      ...
      var b = this;
      k.each(Array.prototype.slice.call(arguments),
      function(a) {
  ...
  var q = function(f, n) {
    ...
    a.bind(this.__selector, "mousedown",
    function(b) {
      a.addClass(this, "drag").bind(window, "mouseup",
      function(b) {
  ...
  var d = function() {
    ...
    var d = this;
    f.bind(this.backgroundElement, "click",
    function() {
      d.hide()
    })
  };
